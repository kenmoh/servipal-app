            ...
            <View>
              <Text className="text-[10px] text-slate-400 font-poppins-light">
                ...
                <Text className="text-xs text-slate-900 dark:text-slate-200  font-poppins-medium">
                 { product?.shipping_cost! > 0 ? `₦ ${product.shipping_cost}`:"Free Delivery" }
                </Text>
          ...
          <View className="flex-row items-center gap-2">
            ...
            <View>
              ...
              <Text className="text-xs text-slate-900 dark:text-slate-200 font-poppins-medium">
                ...
                {Number(product?.return_days) > 0 ?`${product.return_days} Days` : "N/A"}
              </Text>
            </View>
          </View>
          <View className="flex-row items-center gap-2">
            ...
            <View>
              ...
              <Text className="text-xs text-slate-900 dark:text-slate-200 font-poppins-medium">
                {Number(product?.warranty) > 0 ? `${product.warranty} Years` : "N/A"}
              </Text>
            </View>
          </View>
        </View>
