...
const PHONE_REGEX = /^\+234\d{10,15}$/;
const PHONE_ERROR =
  "Use format +234XXXXXXXXXX (e.g., +2347067543677)";
...
const AddRider = () => {
  ...
  */
  ...
  const handleError = (error: Error) => {
    // Translate raw backend validation errors into a friendly message.
    if (/String should match pattern/i.test(error.message)) {
      showError(
        "Invalid Phone Number",
        `Phone number must be in the format +234XXXXXXXXXX (e.g., +2347067543677).`,
      );
      return;
    }
