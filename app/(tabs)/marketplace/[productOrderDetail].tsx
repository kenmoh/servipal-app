      ...
      >
        <View className="p-4 gap-4 flex-1">
          ...
          <View className="bg-input rounded-xl p-4">
            <View className="flex-row space-x-4">
              ...
              <View className="flex-1 space-y-2 ml-5">
                <Text
                  className="text-lg text-primary font-poppins"
                  numberOfLines={2}
                >
                  {name}
                </Text>
          ...
          <View className="bg-input rounded-xl p-4  space-y-4">
            <Text className="text-lg font-semibold text-primary font-poppins">
              Your Selection
            </Text>
            ...
            {sizes && (
              <View className="space-y-2 mt-3">
                <Text className="text-sm font-medium text-primary font-poppins">
                  Sizes
                </Text>
                <View className="flex-row flex-wrap gap-2">
                  {JSON.parse(sizes as string).map(
          ...
          <View className="bg-input rounded-xl p-4  space-y-3">
            ...
            <Text className="text-sm text-gray-500 font-poppins-light mb-1">
              Provide your delivery address and any special instructions you may
              have.
            </Text>
          </View>
          ...
          <View className="rounded-xl p-4  bg-input space-y-3">
            ...
            <View className="space-y-2">
              ...
              <View className="flex-row justify-between items-center">
                <Text className="text-sm font-poppins-light text-muted">
                  Quantity
                </Text>
                <Text className="text-sm text-muted font-poppins-light">
                  {quantity}
